...
public class ParametrDeCommandApparisePourPremierArticle extends ActionTestScript{
	...
	*/
	...
	public void TcParametrDeCommandApparisePourPremierArticle(){
		...
		exec(2,new ActionMouseKey(this, 0, 0, 0, el(clv("2"), false, "A", prp(Operators.EQUAL, "data-title", clv(FoodItem))), ms(Mouse.CLICK)));
		exec(3,new ActionCallscript(this, clv("subscripts.ParametreDeCommande"), false, false, clv("assets:///data/data_construction_de_commande/ParametreDeCommande.csv"), null));
		exec(4,new ActionMouseKey(this, 0, 0, 0, el(clv("0"), false, "LABEL", prp(Operators.EQUAL, "class", clv("checkbox-container")), prp(Operators.EQUAL, "text", clv("Sauce douce"))), ms(Mouse.CLICK)));
