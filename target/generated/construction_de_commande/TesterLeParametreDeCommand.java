...
public class TesterLeParametreDeCommand extends ActionTestScript{
	...
	*/
	...
	public void TcTesterLeParametreDeCommand(){
		...
		com.ats.generator.variables.Variable Result = var("Result", clv(""));

		//   ---< Actions >---   //

		exec(0,new ActionCallscript(this, clv("subscripts.TesterLeParametreDeCommandeSubscript"), false, true, clv("assets:///data/data_construction_de_commande/TesterParametreDeCommand.csv"), null));
	}
}